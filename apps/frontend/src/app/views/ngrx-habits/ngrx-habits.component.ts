...
@Component({
  selector: 'app-ngrx-habits',
  imports: [CommonModule, FormsModule],
  templateUrl: './ngrx-habits.component.html',
})
export class NgrxHabitsComponent implements OnInit {
  ...
  protected saveHabit(): void {
    ...
    this.store.dispatch(HabitActions.createHabit({ payload: { name: trimmedName, habit_date: this.habitDate } }));
    this.name = '';
    this.habitDate = '';
  }
}
